...
import { SignupComponent } from './features/auth/presentation/signup/signup.component';
import { LandingComponent } from './features/landing/landing.component';
import { OtpComponent } from './features/auth/presentation/otp/otp.component';
import { CreateProfileComponent } from './features/auth/presentation/create-profile/create-profile.component';
...
export const routes: Routes = [
    ...
    { path: `create-profile`, component: CreateProfileComponent, canActivate: [otpGuard] },
